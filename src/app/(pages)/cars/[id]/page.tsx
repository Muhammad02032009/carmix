...
export default function CarPage() {
  ...
  async function getCar() {
    try {
      ...
      const foundCar = data.find((el: Car) => el.id == carId); 
  ...
  const carFeatures = [
    {
      ...
      description: 'Unleash the power under the hood',
    },
    {
      icon: Fuel,
      label: 'Fuel Efficiency',
      value: `${car.fuelEfficiency} km/L`,
      description: 'Eco-friendly performance',
    },
    {
      icon: Wind,
      label: 'Max Speed',
      value: `${car.maxSpeed} km/h`,
      description: 'Push the limits of speed',
    },
    {
      icon: Zap,
      label: 'Acceleration',
      value: `${car.acceleration} s (0-100 km/h)`,
      description: 'Feel the thrill of quick acceleration',
    },
    {
      icon: Scale,
      label: 'Weight',
      value: `${car.weight} kg`,
      description: 'Perfectly balanced for optimal performance',
    },
  ];

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-200 dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        ...
        <div className="bg-white dark:bg-gray-950 rounded-xl shadow-2xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            >
              ...
              <h1 className="mt-1 text-3xl lg:text-4xl font-bold text-gray-900 leading-tight dark:text-gray-50">
                {car.model}
              </h1>
              <p className="mt-2 text-gray-600 dark:text-gray-50">
                {car.year} {car.type}
              </p>
              <p className="mt-4 text-2xl lg:text-3xl font-bold text-red-600">
                ${car.price}
              </p>
              <p className="mt-2 text-gray-600 dark:text-gray-50">
